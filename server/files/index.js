...
window.onload = function () {
  ...
  xhr.onload = function () {
    ...
    if (xhr.status === 200) {
      ...
      // Add a button for all movies
      const allMoviesButton = document.createElement("button");
      allMoviesButton.textContent = "All";
      allMoviesButton.addEventListener("click", () => loadMovies());
      const allMoviesLi = document.createElement("li");
      allMoviesLi.appendChild(allMoviesButton);
      listElement.appendChild(allMoviesLi);
